    ...
    <f7-page>
        ...
        <f7-list form style="margin: auto 0; ">
            ...
            <f7-list-item title="Ngày cập nhật">
                <f7-input type="date" :value="getFeature.attributes.NgayCapNhat"
                 @input="getFeature.attributes.NgayCapNhat = $event.target.value"
                 disabled></f7-input>
            </f7-list-item>
            ...
            <f7-list-item title="Người cập nhật">
                <f7-input type="text" @input="getFeature.attributes.NguoiCapNhat = $event.target.value"></f7-input>
            </f7-list-item>
        </f7-list>
