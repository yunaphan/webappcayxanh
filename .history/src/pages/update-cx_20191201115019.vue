    ...
    <f7-page>
        ...
        <f7-list form style="margin: auto 0; ">
            ...
            <f7-list-item title="Tên cây xanh" smart-select :smart-select-params="{openIn: 'sheet'}">
                {{getSelectedFeature.attributes.MaTenCX}}
            ...
            <f7-list-item title="Tuyến đường" -model="getSelectedFeature.attributes.TuyenDuong" smart-select :smart-select-params="{openIn: 'sheet'}">
                <select v-model="getSelectedFeature.attributes.TuyenDuong">
