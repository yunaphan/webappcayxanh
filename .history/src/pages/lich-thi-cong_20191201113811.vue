         ...
         <f7-list form style="margin: auto 0; ">
            ...
            <f7-list-item title="Ngày bắt đầu">
             ...
             <f7-list-item title="Ngày hoàn thành">
              ...
              <f7-list-item :disabled="user.quyen != 2" title="Trạng thái thi công" smart-select :smart-select-params="{openIn: 'sheet'}">
...
export default {
    ...
    methods: {
       ...
       {
           axios.put(this.$store.state.url_web + 'chi-tiet-lich-thi-cong/'+this.lich_thi_cong.macttc,{
                headers: {
                    Authorization: "Token "+ this.$cookies.get('key')
                }
           }, this.lich_thi_cong).then((response) => {
               console.log(response.data)
           })
       }
    },
