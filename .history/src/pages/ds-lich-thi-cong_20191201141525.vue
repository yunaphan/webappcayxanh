    ...
    methods: {
        ...
        api_hinh_thuc_thi_cong()
        {
            ...
            },
            {
                ...
                axios.get(this.$store.state.url_web + 'hinh-thuc-thi-cong/?nhomthiconglich='+response.data.nhomthicong,{
                    headers: {
                        Authorization: "Token "+ this.$store.state.token
                    }
                }).then((response) => {
        ...
        api_lich_thi_cong()
        {
            axios.get(this.$store.state.url_web + 'chi-tiet-lich-thi-cong/',{
                 headers: {
                    Authorization: "Token "+ this.$store.state.token
                }
            }).then((response) => {
